...
- 查准率（precision）
  ...
  - ![](https://latex.codecogs.com/svg.latex?P=\frac{T P}{T P+F P})
  - ![](https://latex.codecogs.com/gif.latex?P%3D\frac{T P}{T P&plus;F P})
  - ![](https://latex.codecogs.com/svg.latex?P=\frac{TP}{TP+FP})
  - ![](https://latex.codecogs.com/gif.latex?P%3D\frac{TP}{T P&plus;F P})
